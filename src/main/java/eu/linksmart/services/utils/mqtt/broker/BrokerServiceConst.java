...
public interface BrokerServiceConst {
    ...
    String KEY_STORE_FILE_PATH ="connection_broker_mqtt_security_keyStorePath";
    ...
    String USER_DEFAULT_CREDENTIALS ="messaging_client_mqtt_security_default_credentials";
}
